...
public class MovementBitmasks {
    ...
    public static final Object2ObjectMap<Square, Long2LongOpenHashMap> BISHOP_MOVES = new Object2ObjectOpenHashMap<>(64, 1.0F);
    public static final Object2ObjectMap<Square, Long2LongOpenHashMap> ROOK_MOVES = new Object2ObjectOpenHashMap<>(64, 1.0F);
    ...
    static {
        ...
        // Initialize sliding piece movements
        for (Square square : Square.values()) {
